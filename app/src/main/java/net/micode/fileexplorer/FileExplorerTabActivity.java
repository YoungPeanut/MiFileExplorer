...
import net.micode.fileexplorer.category.FileCategoryActivity;
...
public class FileExplorerTabActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bar.setSelectedNavigationItem(PreferenceManager.getDefaultSharedPreferences(this)
                .getInt(INSTANCESTATE_TAB, FileUtil.CATEGORY_TAB_INDEX));
    }
    ...
    public void onConfigurationChanged(Configuration newConfig) {
        if (getActionBar().getSelectedNavigationIndex() == FileUtil.CATEGORY_TAB_INDEX) {
            FileCategoryActivity categoryFragement =(FileCategoryActivity) mTabsAdapter.getItem(FileUtil.CATEGORY_TAB_INDEX);
    ...
    public void reInstantiateCategoryTab() {
        mTabsAdapter.destroyItem(mViewPager, FileUtil.CATEGORY_TAB_INDEX,
                mTabsAdapter.getItem(FileUtil.CATEGORY_TAB_INDEX));
        mTabsAdapter.instantiateItem(mViewPager, FileUtil.CATEGORY_TAB_INDEX);
    }
