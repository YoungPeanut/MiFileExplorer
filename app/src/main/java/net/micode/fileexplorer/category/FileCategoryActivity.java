...
import net.micode.fileexplorer.category.fav.FavoriteDatabaseHelper.FavoriteDatabaseListener;
import net.micode.fileexplorer.category.fav.FavoriteList;
...
import net.micode.fileexplorer.common.action.FileSortHelper;
import net.micode.fileexplorer.filepath.FileViewActivity;
import net.micode.fileexplorer.common.action.FileViewInteractionHub;
import net.micode.fileexplorer.common.action.FileViewInteractionHub.Mode;
import net.micode.fileexplorer.common.GlobalConsts;
import net.micode.fileexplorer.common.action.IFileInteractionListener;
import net.micode.fileexplorer.R;
import net.micode.fileexplorer.common.util.FileUtil.SDCardInfo;
...
public class FileCategoryActivity extends Fragment implements IFileInteractionListener,
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        mFileViewActivity = (FileViewActivity) ((FileExplorerTabActivity) mActivity)
                .getFragment(FileUtil.SDCARD_TAB_INDEX);
    ...
    public void refreshCategoryInfo() {
        SDCardInfo sdCardInfo = FileUtil.getSDCardInfo();
        if (sdCardInfo != null) {
            mCategoryBar.setFullValue(sdCardInfo.total);
            setTextView(R.id.sd_card_capacity, getString(R.string.sd_card_size, FileUtil.convertStorage(sdCardInfo.total)));
            setTextView(R.id.sd_card_available, getString(R.string.sd_card_available, FileUtil.convertStorage(sdCardInfo.free)));
        }
    ...
    private void copyFileInFileView(ArrayList<FileInfo> files) {
        ...
        mActivity.getActionBar().setSelectedNavigationItem(FileUtil.SDCARD_TAB_INDEX);
    }
    ...
    private void setCategorySize(FileCategoryHelper.FileCategory fc, long size) {
        ...
        setTextView(txtId, getString(resId) + ":" + FileUtil.convertStorage(size));
    }
