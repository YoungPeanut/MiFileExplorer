...
public class FavoriteListAdapter extends ArrayAdapter<FavoriteItem> {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        FileUtil.setText(view, R.id.file_name, item.title != null ? item.title : lFileInfo.fileName);
        if (lFileInfo.ModifiedDate > 0) {
            FileUtil.setText(view, R.id.modified_time, FileUtil.formatDateString(mContext, lFileInfo.ModifiedDate));
        ...
        if (lFileInfo.IsDir) {
            ...
            FileUtil.setText(view, R.id.file_size, FileUtil.convertStorage(lFileInfo.fileSize));
        }
