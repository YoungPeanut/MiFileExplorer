...
package net.micode.fileexplorer.filepath;
...
import net.micode.fileexplorer.common.ActivitiesManager;
...
import net.micode.fileexplorer.category.FileCategoryHelper;
...
public class FileViewActivity extends Fragment implements
    ...
    public boolean onBack() {
        if (mBackspaceExit || !FileUtil.isSDCardReady() || mFileViewInteractionHub == null) {
            return false;
        }
