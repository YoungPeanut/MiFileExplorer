...
package net.micode.fileexplorer.common.action;
...
import net.micode.fileexplorer.common.util.IntentBuilder;
import net.micode.fileexplorer.R;
import net.micode.fileexplorer.common.Settings;
import net.micode.fileexplorer.common.adapterUtil.FileListItem.ModeCallback;
import net.micode.fileexplorer.common.action.FileOperationHelper.IOperationProgressListener;
import net.micode.fileexplorer.common.action.FileSortHelper.SortMethod;
import net.micode.fileexplorer.common.action.TextInputDialog.OnFinishListener;
import net.micode.fileexplorer.category.fav.FavoriteDatabaseHelper;
import net.micode.fileexplorer.filepath.FileViewActivity.SelectFilesCallback;
...
public class FileViewInteractionHub implements IOperationProgressListener {
    ...
    public void onOperationSelectAll() {
        ...
        if (mode == null) {
            ...
            FileUtil.updateActionModeTitle(mode, mContext, getSelectedFileList().size());
        }
    ...
    private boolean doCreateFolder(String text) {
        ...
        if (mFileOperationHelper.CreateFolder(mCurrentPath, text)) {
            mFileViewListener.addSingleFile(FileUtil.GetFileInfo(FileUtil.makePath(mCurrentPath, text)));
    ...
    public void onListItemClick(AdapterView<?> parent, View view, int position, long id) {
        ...
        if (isInSelection()) {
            ...
            FileUtil.updateActionModeTitle(actionMode, mContext, mCheckedFileNameList.size());
            return;
        }
